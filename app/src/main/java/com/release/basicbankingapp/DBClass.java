...
public class DBClass extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        CreateUsers("0","Siddharth Kumar", "sid@gmail.com", 10000, db);
        CreateUsers("1","Lakshya Taragi", "lak@gmail.com", 15000, db);
        CreateUsers("2","Shivansh Singh", "shivansh@gmail.com", 12000, db);
        CreateUsers("3","Aditya Gupta", "aditya@gmail.com", 11000, db);
        CreateUsers("4","Nikhil Kumar", "nikhil@gmail.com", 18000, db);
        CreateUsers("5","Harsh Surya", "surya@gmail.com", 17000, db);
        CreateUsers("6","Abhishek Yaduvanshi", "abhi@gmail.com", 13000, db);
        CreateUsers("7","Aditya Patel", "patel@gmail.com", 19000, db);
        CreateUsers("8","Ashwini Kumar", "ashwini@gmail.com", 20000, db);
        CreateUsers("9","Vishal Kumar", "vis@gmail.com", 9900, db);
    }
